...
int cmdDoctor(const Options& o) {
    ...
    const nlohmann::json runtimeCapabilities = {
        ...
        {"directComponentExecution", {
            ...
            {"standaloneExpressionParser", true},
            {"typedExpressionIr", true},
            {"typedExpressionIrDependencyAnalysis", true},
            {"typedExpressionIrJsCodegen", true},
            ...
            {"productionComponentDebugPayloadIsolation", true},
            {"productionRuntimeDynamicCompilation", false},
        ...
        {"performanceTarget", {
            ...
            {"browserRuntimeDomAssertions", true},
            {"browserRuntimeLargeFixtureBudgets", true},
            {"benchmarkFixtures", {
                "static_counter",
                "keyed_list",
                "control_flow",
                "composition",
                "large_keyed_rows",
                "nested_component_update",
            }},
            {"browserAssetBudgets", "first-slice index/runtime/component/app/update-plan byte budgets"},
            {"dynamicGeneratedUpdateFunctions", "not executed by shipped runtime; static component modules are the production path"},
            {"productionRuntimeDynamicCompilation", false},
