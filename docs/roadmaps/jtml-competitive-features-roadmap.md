...
29. Next: remote registry, semantic versions, richer incremental LSP text sync, package-aware auto-imports, stores, richer object field/collection types, and runtime `ComponentInstance` objects once P0 runtime semantics are stable.
